...
function AuthForms() {
  ...
  return (
    <div className="flex min-h-[100dvh] w-full bg-[#111111] text-zinc-50 overflow-hidden font-sans flex-col lg:flex-row">
      {/* LEFT SIDE: Brand */}
      <div className="relative flex flex-col items-center justify-center lg:w-1/2 p-8 bg-[#fff44f] text-[#111111] min-h-[40vh] lg:min-h-screen">
      ...
      {/* RIGHT SIDE: Forms */}
      <div className="relative flex flex-col items-center justify-center lg:w-1/2 p-6 md:p-12 lg:p-24 bg-[#111111]">
        <div className="w-full max-w-md">
          {/* Tab Switcher */}
          <div className="flex relative bg-[#1a1a1a] p-1.5 rounded-2xl mb-10 border border-white/5">
            {["login", "signup"].map((tab) => (
              ...
              >
                {activeTab === tab && (
                  <motion.div
                    layoutId="activeTab"
                    className="absolute inset-0 bg-[#fff44f] rounded-xl"
                  ...
                  <form onSubmit={handleLoginSubmit} className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-5 mt-2">
                      <div className="flex flex-col gap-2.5">
                        ...
                        <input
                          type="email"
                          className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-4 text-sm text-white focus:outline-none focus:border-[#fff44f]/50 focus:ring-1 focus:ring-[#fff44f]/50 transition-all"
                      ...
                      <div className="flex flex-col gap-2.5">
                        <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest flex justify-between">
                          Password
                          <a href="#" className="text-[#fff44f]/80 hover:text-[#fff44f] normal-case tracking-normal">Forgot?</a>
                        </label>
                        <input
                          type="password"
                          className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-4 py-4 text-sm text-white focus:outline-none focus:border-[#fff44f]/50 focus:ring-1 focus:ring-[#fff44f]/50 transition-all"
                    ...
                    <button
                      ...
                      className="btn-press w-full mt-2 bg-[#fff44f] text-[#111111] hover:bg-yellow-300 font-bold py-4 rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
